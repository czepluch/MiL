\section{Interview 1: 29.09.13.Andreas}
\label{interview_1}
...
\label{i1q13}
\noindent \textbf{Kan du uddybe hvad du mener med at de har svært ved at overholde deadlines?} \\
Det sker ret tit. Det er problem fordi det kan resultere i at andre arrangører som er afhængige af at den deadline bliver overholdt, også bliver forsinkede. Jeg vil gætte på at der er til hver møde er en 3-4 stykker som siger "det har jeg ikke lige nået at kigge på". Det er jo også frivilligt arbejde, det må man erkende der er en hvis risiko ved.
